...
class Payroll_model extends CI_Model {
    ...
    function getPayslip($id) {
        ...
        $query = $this->db->select("staff.name,staff.surname,department.department_name as department,staff_designation.designation,staff.employee_id,staff_payslip.*")
        ...
        ->where("staff_payslip.id", $id)->get("staff_payslip");
