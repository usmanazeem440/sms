...
class Section_model extends CI_Model {
    ...
    public function getClassSubjects($id,$section_id,$staff_id){
        $this->db->select('subjects.id , subjects.name')->from('subjects');
        ...
        $this->db->where('teacher_subjects.class_id', $id);
