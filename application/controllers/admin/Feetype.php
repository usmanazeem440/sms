    ...
    function index() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = array(
                ...
                'code' => $this->input->post('code'),				'is_taxable' => (trim($this->input->post('is_taxable') <>'')?'YES':'NO'),                'description' => $this->input->post('description'),
            );			
    ...
    function edit($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = array(
                'id' => $id,
                'type' => $this->input->post('name'),
                'code' => $this->input->post('code'),				'is_taxable' => (trim($this->input->post('is_taxable') <>'')?'YES':'NO'),
