    ...
    function payslip() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($checkForUpdate == true) {
                ...
                $this->session->set_flashdata("msg", "<div class='alert alert-success'>Payslip generated successfully</div>");

                // redirect('admin/payrollsearch/' . $month . "/" . $year . "/" . $role);
                redirect('admin/payroll/search/' . $month . "/" . $year);
