                ...
                <div class="box box-info" style="padding:5px;">
                    <div class="box-header with-border">
                        ...
                        <div class="pull-right box-tools">
                            <a href="<?php echo site_url('admin/feesforward/sampleFeeUpdate') ?>">
                    ...
                    <div class="box-body">
                        ...
                        2. Record will be updated on basis of admission number<br/>
                        <hr/>
                    </div>
                    ...
                    <hr/>
            <form action="<?php echo site_url('admin/feesforward/bulkFeesUpdate') ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select  id="csv_class_id" name="class_id" class="form-control"  >
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select  id="csv_section_id" name="section_id" class="form-control" >
                                    <option value=""   ><?php echo $this->lang->line('select'); ?></option>
                                </select>
                        ...
                        <div class="col-md pt20" style="margin-right: 2%;">
                            <button type="submit" class="btn btn-info pull-right">Collect Fees</button>
                        </div>
                    </div>
                </div>
            </form>
...
<script type="text/javascript">
    ...
    /////////////////////////////CSV Update fees section start////////////////////////////////
    $(document).ready(function () {

        var class_id = $('#csv_class_id').val();
        var section_id = '<?php echo set_value('section_id', 0) ?>';
        csvGetSectionByClass(class_id, section_id);
    });

    $(document).on('change', '#csv_class_id', function (e) {
        $('#csv_section_id').html("");
        var class_id = $(this).val();
        csvGetSectionByClass(class_id, 0);
    });


    function csvGetSectionByClass(class_id, section_id) {
        ...
        if (class_id != "") {
            ...
            $.ajax({
                ...
                dataType: "json",
                beforeSend: function () {
                    $('#csv_section_id').addClass('dropdownloading');
                },
                success: function (data) {
                    ...
                    $('#csv_section_id').append(div_data);
                },
                complete: function () {
                    $('#csv_section_id').removeClass('dropdownloading');
                }
            });
        }
    }
    /////////////////////////////CSV Update fees section end////////////////////////////////
