                ...
                <div class="row">
                    <div class="col-xs-6">
                        ...
                        <address>
                            ...
                            <span><strong><?php echo $this->lang->line('parent'); ?></strong>:<?php echo $invoicesDetails[0]['parents']['guardian_id']; ?> </span><br/>
                        </address>
                    </div>
                                ...
                                foreach ($invoicesDetails as $fee_key => $feeList) {
                                   ...
                                   $feetype_balance = $feeList['fee_groups_feetype'][0]['amount'] - ($discount + $fee_paid) + $tax_amount;
                                    ...
                                    <tr  class="dark-gray">
                                        ...
                                        <td><?php echo $currency_symbol . $tax_amount; 
                                        $total_paid_tax += $tax_amount; ?></td>
                                        <td class="text text-right"><?php echo ($currency_symbol . number_format($feeList['fee_groups_feetype'][0]['amount'] - $discount + $tax_amount, 2, '.', '')); 
