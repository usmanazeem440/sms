                        ...
                        <div class="box-header">
                            ...
                            <div class="row display-flex">
                                        ...
                                        <div class="feebox">
                                            ...
                                            <table class="table3" id="tableID">
                                                ...
                                                <tr id="row0">
                                                    ...
                                                    <td><input type="text" onkeyup="add_allowance()" id="allowance_amount" name="allowance_amount[]" class="form-control" value="0"></td>
                                        ...
                                        <div class="feebox">
                                            ...
                                            <table class="table3" id="tableID2">
                                                ...
                                                <tr id="deduction_row0">
                                                    ...
                                                    <td><input type="text" onkeyup="add_allowance()" id="deduction_amount" name="deduction_amount[]" class="form-control" value="0"></td>
                                        ...
                                        <div class="payrollbox feebox">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <input class="form-control" onkeyup="add_allowance()" name="basic" value="<?php
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <input class="form-control" readonly name="total_allowance" id="total_allowance"  type="text" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8 deductiondred">
                                                    ...
                                                    <input class="form-control" readonly name="total_deduction" id="total_deduction" type="text" style="color:#f50000" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <input class="form-control" readonly name="gross_salary" id="gross_salary" value="0" type="text" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8 deductiondred">
                                                    ...
                                                    <input class="form-control" onkeyup='add_allowance()' name="tax" id="tax" value="0" type="text" />
                                ...
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <button type="submit" id="contact_submit" class="btn btn-primary pull-right"><?php echo $this->lang->line('save'); ?></button>
