                ...
                <div class="row">
                    <?php if ($this->rbac->hasPrivilege('student_count_widget', 'can_view')) { ?>
                        ...
                        <div class=" col-lg-4 col-md-6 col-sm-12">
                            <a href="<?php echo site_url('studentfee') ?>" style="width: 100%">
                                <div class="dashboard-summery-one mg-b-20">
                                    <div class="row align-items-center">
                                        <div class="col-md-4">
                                            <div class="item-icon bg-light-green ">
                                                <img class="item-icon bg-light-green" src="<?php echo base_url()?>backend/dist/img/class.png" alt="Students">
                                        ...
                                        <div class="col-md-8">
                                            <div class="item-content">
                                                <div class="item-title"><?php echo $this->lang->line('student'); ?></div>
                                                <div class="item-number"><span class="counter" data-num="<?= $month_expense ?>"><?php echo $total_students; ?></span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <a href="<?php echo site_url('studentfee') ?>" style="width: 100%">
                                <div class="dashboard-summery-one mg-b-20">
                                    <div class="row align-items-center">
                                        <div class="col-md-4">
                                            <div class="item-icon bg-light-green ">
                                                <img class="item-icon bg-light-green" src="<?php echo base_url()?>backend/dist/img/money.png" alt="Students">
                                        ...
                                        <div class="col-md-8">
                                            <div class="item-content">
                                                <div class="item-title"><?php echo $this->lang->line('monthly_fees_collection'); ?></div>
                                                <div class="item-number"><span class="counter" data-num="<?= $month_collection ?>"><?php echo $currency_symbol . $month_collection; ?></span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <a href="<?php echo site_url('studentfee') ?>" style="width: 100%">
                                <div class="dashboard-summery-one mg-b-20">
                                    <div class="row align-items-center">
                                        <div class="col-md-4">
                                            <div class="item-icon bg-light-green ">
                                                <img class="item-icon bg-light-green" src="<?php echo base_url()?>backend/dist/img/credit-card.png" alt="Students">
                                        ...
                                        <div class="col-md-8">
                                            <div class="item-content">
                                                <div class="item-title"><?php echo $this->lang->line('monthly_expenses'); ?></div>
                                                <div class="item-number"><span class="counter" data-num="<?= $month_expense ?>"><?php echo $currency_symbol . $month_expense; ?></span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <?php } ?>
                    <?php foreach ($roles_other as $key => $value) {
                        ...
                        <a href="#" style="width: 100%">
                            <div class="dashboard-summery-one mg-b-20">
                                <div class="row align-items-center">
                                    <div class="col-md-4">
                                        <div class="item-icon bg-light-green ">
                                            <img class="item-icon bg-light-green" src="<?php echo base_url()?>backend/dist/img/user-icon.png" alt="Students">
                                    ...
                                    <div class="col-md-8">
                                        <div class="item-content">
                                            ...
                                            <div class="item-number"><span class="counter" data-num="<?= $value ?>"><?php echo $value; ?></span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
