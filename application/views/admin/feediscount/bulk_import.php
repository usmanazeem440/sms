...
<div class="content-wrapper" style="min-height: 946px;">
    <section class="content-header">
        <h1>
            <i class="fa fa-book"></i> <?php echo "Import Discounts"; ?> <small><?php echo $this->lang->line('student1'); ?></small></h1>
    </section>
    <!-- Main content -->
                ...
                <div class="box box-info" style="padding:5px;">
                    <div class="box-header with-border">
                        ...
                        <div class="pull-right box-tools">
                            <a href="<?php echo site_url('admin/Feediscount/exportformat') ?>">
                    ...
                    <hr/>
                    <form action="<?php echo site_url('admin/Feediscount/import') ?>"  id="employeeform" name="employeeform" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 pt20">
                                    <button type="submit" class="btn btn-info pull-right"><?php echo "Import"; ?></button>
                                </div>
