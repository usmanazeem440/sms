                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="pull-right">
                            <a href="<?php echo site_url('admin/Feediscount/bulkImportDiscounts') ?>" class="btn btn-sm btn-default">Bulk Import Discounts</a>
                        </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('admin/Feediscount/applyIndiviualDiscount') ?>" method="post" class="">
                                        ...
                                        foreach ($resultlist as $student) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="pull-right">
                                                   ...
                                                   <a href="<?php echo base_url(); ?>admin/Feediscount/applyStudentDiscountView/<?php echo $student['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="Assign Discount">
