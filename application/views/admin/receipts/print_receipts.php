                ...
                <div class="row">
                    <div class="col-xs-7">
                        ...
                        <address>
                            ...
                            <span><strong>Parent ID:</strong> <?php echo $receiptsDetails[0]['parents']['guardian_id']; ?> </span><br/>
                        </address>
                    </div>
                                ...
                                foreach ($receiptsDetails as $fee_key => $feeList) {
                                    ...
                                    <tr  class="dark-gray">
                                        ...
                                        <td class="text text-right">
                                            <?php //dd($feeList['fee_groups_feetype'][0],'',0); ?>
                                            <?php echo $currency_symbol . $feeList['fee_groups_feetype'][0]['amount']; ?></td>
                                    ...
                                    if (is_object($fee_deposits)) {
                                        foreach ($fee_deposits as $fee_deposits_key => $fee_deposits_value) {
                                            ...
                                            <tr class="white-td">
                                                ...
                                                <td class="text text-right test"><?php echo ($currency_symbol . number_format($fee_deposits_value->amount, 2, '.', '')); ?></td>
