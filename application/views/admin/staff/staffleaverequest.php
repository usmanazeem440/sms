                        ...
                        <div class="col-md-12 table-responsive">  
                            ...
                            <table class="table mb0 table-striped table-bordered examples">
                                ...
                                <tr>
                                    ...
                                    <th><?php echo ('Alloted Leaves'); ?></th>

                                    <td><span id='alloted_leaves'></span></td>

                                    <th><?php echo ('Availed Leaves'); ?></th>

                                    <td><span id="availed_leaves"></span></td>
    ...
    function getRecord(id) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $('#alloted_leaves').html(result.alloted_leaves);
                $('#availed_leaves').html(result.availed_leaves);
