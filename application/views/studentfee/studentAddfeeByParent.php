                    ...
                    <div class="box-header">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <a href="#" class="btn btn-xs btn-info generate_invoices"><i class="fa fa-file"></i> <?php echo $this->lang->line('generate_invoices'); ?> </a>
                            </div>
                            <div class="col-md-8 ">
                                    ...
                                    for($i = 0; $i < count($students); $i++) {
                                        ...
                                        foreach ($student_due_fee as $key => $fee) {
                                            ...
                                            foreach ($fee->fees as $fee_key => $fee_value) {
                                                ...
                                                if($fee_value->type == "Tuition Fee"  || $fee_value->type == "Saudi Student"){
                                                ...
                                                <td>
                                                    <input class="checkbox" type="checkbox" name="fee_checkbox"
                                                           ...
                                                           data-is_invoiced="<?php echo (trim($fee_value->invoice_number)!= ''?'yes':'no') ;?>"
                                                ...
                                                <td align="left" class="text text-left width85">
                                                    ...
                                                    if(trim($fee_value->code) == "Previous Session Balance" && $previous_session_balance_tax["previous_session_balance_tax"] == "disabled")
                                                        $feeTax = 0;
                                                            ...
                                                            $feeTax = 0;
                                                    $balance_payment = number_format(((((((float)$feeTax * ((float)$balance_amount - $discount_unpaid)) / 100) + $balance_amount) - $discount_unpaid) - $fee_paid),2);
...
//                                                        echo(number_format($balance_amount, 2, '.', '')); ?>
                                                ...
                                                <td class="text text-right">
                                                    ...
                                                    if(trim($fee_value->code) == "Previous Session Balance" && $previous_session_balance_tax["previous_session_balance_tax"] == "disabled")
                                                    {
                                                        $calc_balance_amount += ($balance_amount - $discount_unpaid  - $fee_paid);
                                                        echo (number_format($balance_amount - $discount_unpaid - $fee_paid, 2, '.', ''));
                                                    }
                                                    else if($fee_value->is_taxable == "YES" && (float)$fee_tax["fee_tax"] > 0){
                                    ...
                                    for($modal_i = 0; $modal_i < count($students); $modal_i++) {
                                        ...
                                        foreach ($modal_student_due_fee as $key => $fee) {
                                            ...
                                            foreach ($fee->fees as $fee_key => $modal_fee_value) {
                                                ...
                                                if($modal_fee_value->type == "Tuition Fee" || $modal_fee_value->type == "Saudi Student"){
                                                ...
                                                $showRow = 0;
                                                if(trim($modal_fee_value->code) == "Previous Session Balance" && $previous_session_balance_tax["previous_session_balance_tax"] == "disabled"){
                                                ...
                                                if(floatval($showRow) > 0.01){
                                                    ...
                                                    if(trim($modal_fee_value->code) == "Previous Session Balance" && $previous_session_balance_tax["previous_session_balance_tax"] == "disabled"){
                                                        echo "0.00";
                                                    } else if(($modal_fee_value->is_taxable == "YES" && (float)$fee_tax["fee_tax"] > 0)) {
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php
                                                        if(trim($modal_fee_value->code) == "Previous Session Balance" && $previous_session_balance_tax["previous_session_balance_tax"] == "disabled"){
                                                            $amountPayAble =  (number_format($modal_balance_amount - $modal_fee_paid, 2, '.', ''));
                                                        } else  if($modal_fee_value->is_taxable == "YES" && (float)$fee_tax["fee_tax"] > 0){
                                                            $amountPayAble =  (number_format(abs((((((float)$fee_tax["fee_tax"] * ((float)$modal_balance_amount - $modal_discount_unpaid)) / 100) + $modal_balance_amount) - $modal_discount_unpaid) - $modal_fee_paid), 2, '.', ''));
                                                        }else{
                                                            $amountPayAble =  (number_format($modal_balance_amount - $modal_fee_paid, 2, '.', ''));
                                                        }

                                                        ?>
<input type="number"  onkeyup="updateTotal(<?php echo ($modal_fee_value->is_taxable== 'YES') ?  $fee_tax["fee_tax"]:0; ?>)" class="amount_paying"  data-amount_payable="<?php echo $amountPayAble?>" value="<?php echo $amountPayAble?>"/>
                                                    </td>
                                                    </tr>
                                                <?php }}}
                                    }?>
    ...
    $(document).ready(function () {
        $(document).on('click', '.generate_invoices', function () {
            ...
            $.each($("input[name='fee_checkbox']:checked"), function () {
                ...
                var fee_master_id = $(this).data('fee_master_id');
                var fee_groups_feetype_id = $(this).data('fee_groups_feetype_id');
                var is_invoiced = $(this).data('is_invoiced');
                item = {}
                item ["fee_session_group_id"] = fee_session_group_id;
                item ["fee_master_id"] = fee_master_id;
                item ["fee_groups_feetype_id"] = fee_groups_feetype_id;
...
//                });
    ...
    $(function () {
        $(document).on('change', ".amount_paying", function (e) {
            var max = parseFloat($(this).attr('data-amount_payable'));
