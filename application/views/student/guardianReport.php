        ...
        <div class="row">
           <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo site_url('student/guardianreport') ?>" method="get" class="">
                        <div class="box-body row">
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="form-group">  
                                    ...
                                    <select  id="section_id" name="section_id" class="form-control"  value="<?php echo $section_id;?>">
                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                                    </select>
