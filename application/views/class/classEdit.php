                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo site_url('classes/edit/' . $id) ?>"  method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo "Attendance Type"; ?></label></label><small class="req"> *</small><br/>
                                    <input type="radio" name="attendance_type" <?php if($vehroute[0]->attendance_type == '0'){ echo 'checked';} ?> value="0"/> &nbsp;Full Day Attendance
                                    <br/>
                                    <input type="radio" name="attendance_type" <?php if($vehroute[0]->attendance_type == '1'){ echo 'checked';} ?> value="1"/> &nbsp;Attendance By Subject
                                    <hr/>
                                </div>
                                ...
                                <tbody>
                                    ...
                                    foreach ($vehroutelist as $vehroute) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($vehroute->attendance_type == '0'){
                                                    echo "Full Day";
                                                }else{
                                                    echo "Subject Wise";
                                                }
