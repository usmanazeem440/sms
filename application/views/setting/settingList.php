                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tr>
                                    <td><strong><?php echo $this->lang->line('fee_tax'); ?></strong></td>
                                    <td class="mailbox-name"> <?php echo $settinglist[0]['fee_tax'] ?> %</td>
                                </tr>


                                <tr>
                                    <td><strong><?php echo $this->lang->line('sales_tax'); ?></strong></td>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <form role="form" id="schsetting_form" action="<?php echo site_url('schsettings/ajaxedit') ?>">
                        ...
                        <div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('fee_tax'); ?>(%)</label><small class="req"> *</small>

                            <input type="number" name="fee_tax" id="fee_tax" class="form-control">

                            <span class="text-danger"><?php echo form_error('fee_tax'); ?></span>
                        </div>


                        <div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('sales_tax'); ?>(%)</label><small class="req"> *</small>
						...
						<div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            ...
                            <div class="clearfix"></div>
                            <label class="radio-inline">
                                <input type="radio" name="previous_session_balance_tax" value="disabled" ><?php echo $this->lang->line('disabled'); ?>
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="previous_session_balance_tax" value="enabled"><?php echo $this->lang->line('enabled'); ?>
                            </label>
                        </div>
    ...
    $('.edit_setting').on('click', function (e) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $('input[name="fee_tax"]').val(result.fee_tax);
                $('input[name="sales_tax"]').val(result.sales_tax);
				...
				$("input[name=previous_session_balance_tax][value=" + result.previous_session_balance_tax + "]").attr('checked', 'checked');
