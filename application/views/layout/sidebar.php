...
///////////////////////////////// Book POS Menu Section Start///////////////////////////////////////
    ...
    if ($this->rbac->hasPrivilege('book_store', 'can_view')) {
        ...
        <?php
                     ...
                     //  if ($this->module_lib->hasActive('receipts')) {
                            if ( $this->rbac->hasPrivilege('receipts', 'can_view')) {
                                ?>
                                <li class="treeview <?php echo set_Topmenu('receipts'); ?>">
                                    <a href="#">
                                        <i class="fa fa-money"></i> <span> <?php echo $this->lang->line('receipts'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                                    </a>
                                    <ul class="treeview-menu">
                                        <?php if ($this->rbac->hasPrivilege('receipts', 'can_view')) { ?>
                                            <li class="<?php echo set_Submenu('admin/receipts/index'); ?>"><a href="<?php echo base_url(); ?>admin/receipts/index"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('receipts'); ?></a></li>
                                            <?php
                                        }
                                        ?>
                                    </ul>
                      ...
                      // }
                        ...
                        if ($this->module_lib->hasActive('invoices')) {
                            if ( $this->rbac->hasPrivilege('invoices', 'can_view')) {
                                ?>
                                <!-- Temporary Hide -->
                                <li class="d-none treeview <?php echo set_Topmenu('invoices'); ?>">
                                    <a href="#">
